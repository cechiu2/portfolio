...
// TrackingVideoMockup — phone mockup for the Personal Tracking decision block.
...
export default function TrackingVideoMockup() {
  ...
  return (
    <div ref={containerRef} className={PHONE_FRAME}>
      {prefersReduced ? (
        ...
        <div
          className="h-full w-full bg-gradient-to-b from-purple/30 to-plum/50"
          role="img"
          aria-label="Personal tracking redesign demo"
        />
      ) : (
        <video
          ref={videoRef}
        ...
        >
          ...
          <img
            src="/images/tracking-poster.png"
            alt="Personal tracking redesign demo"
